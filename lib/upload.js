...
try {
  ...
  AWS.config.accessKeyId = getEnvVariable('AWS_ACCESS_KEY_ID') || getEnvVariable('S3_ACCESS_KEY');
  AWS.config.secretAccessKey = getEnvVariable('AWS_SECRET_ACCESS_KEY') || getEnvVariable('S3_SECRET_ACCESS_KEY');
  AWS.config.region = getEnvVariable('AWS_DEFAULT_REGION') || 'us-east-1';

  // bucket where static assets are uploaded to
  var AWS_STATIC_BUCKET_NAME = getEnvVariable('AWS_STATIC_BUCKET_NAME') || getEnvVariable('S3_BUCKET_NAME');
